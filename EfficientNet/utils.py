...
GlobalParams = collections.namedtuple('GlobalParams', [ 'width_coefficient' , 'depth_coefficient'   , 'image_size'  , 'dropout_rate',
...
def get_width_and_height_from_size(x):
    ...
    Args: x (int, tuple or list): Data size.
    Returns:size: A tuple or list (H,W).
    """
    if isinstance(x, int):
        return x, x
...
def calculate_output_image_size(input_image_size, stride):
    ...
    Args:  input_image_size (int, tuple or list): Size of input image.
           stride (int, tuple or list): Conv2d operation's stride.
    Returns: output_image_size: A list [H,W].
    """
...
def get_same_padding_conv2d(image_size=None):
    ...
    Args:   image_size (int or tuple): Size of the image.
    Returns:Conv2dDynamicSamePadding or Conv2dStaticSamePadding.
    """
...
def efficientnet_params(model_name):
    ...
    """
    params_dict = { 'efficientnet-b0': (1.0, 1.0, 224, 0.2),        # Coefficients:   width,depth,res,dropout
