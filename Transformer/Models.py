...
class Encoder(nn.Module):
    ...
    def forward(self, src_seq, src_mask, return_attns=False):
        enc_slf_attn_list = []
        enc_output = self.src_word_emb(src_seq)     # -- Forward
        if self.scale_emb:
...
class Decoder(nn.Module):
    ...
    def forward(self, trg_seq, trg_mask, enc_output, src_mask, return_attns=False):
        ...
        dec_output = self.trg_word_emb(trg_seq)         # -- Forward
        if self.scale_emb:
...
class Transformer(nn.Module):
    ...
    def __init__(   self          , n_src_vocab , n_trg_vocab , src_pad_idx, trg_pad_idx,
                    ...
                    trg_emb_prj_weight_sharing=True, emb_src_trg_weight_sharing=True, scale_emb_or_prj='prj'):
        ...
        self.encoder = Encoder( n_src_vocab = n_src_vocab , n_position = n_position ,
